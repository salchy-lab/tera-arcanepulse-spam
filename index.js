const TARGET_1_DISTANCE = 770; // Max Distance from targets in units. Example Values: 500 = 20m, 770 = 30m, 1010 = 40m
const FIREBALL_SKILL_IDS = [10100,10200,10300,10400, 10500, 10600, 10700, 10800, 10900, 11000, 11100, 11200];
	...
	script.hook('C_USE_ITEM', 3, packet => {
		...
		if (packet.id == 6560) {
			...
			if (bugme == false) {
				...
				script.toServer('C_PLAYER_LOCATION', 5, loc_event);
